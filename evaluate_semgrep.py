...
try:
    from semgrep_tool import scan_python_code
except ImportError:
    print("Error: semgrep_tool.py not found.")
    import sys
    sys.exit(1)

# ================= 配置区域 =================
DATASET_FILE = r"C:\MCP_benchmark\MCP漏洞数据集\mcp_risk_benchmark_v5.jsonl"
OUTPUT_LOG = r"C:\MCP_benchmark\MCP漏洞数据集\benchmark_semgrep_failures.log"
# ===========================================
...
def main():
    ...
    print("\n" + "="*85)
    print("📊 FINAL RESEARCH REPORT (Semgrep 评估结果)")
    print("="*85)
